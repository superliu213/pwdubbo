...
public class DateTimeUtil {
	...
	public static Date BCDToDate(long BCD) throws IllegalArgumentException {
		int year = 0;
		int month = 0;
		int day = 0;
		int hour = 0;
	...
	public static int timeToBCD(Date date) throws IllegalArgumentException {
	...
	public static long dateToBCD(Date date) {
		long year = 0;
		long month = 0;
		long day = 0;
		long hour = 0;
